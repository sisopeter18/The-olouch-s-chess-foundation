...
try {
  ...
  // added new game logic
  document.querySelector('#newgame').addEventListener('click', () => {

    // clear all highlights and flags
    clearHighlights();
    ...
    // you can make this random btn white/black
    board.orientation(gameSetup.orientation)

    // if engine and your side is black
    if (gameSetup.orientation.startsWith('b') && configs.game.engine) {
      // it means your opponent being stockfish is white and should start the game
      startEngineAnalysis();
    }
...
var stockfish = new Worker(!wasmSupported ? './scripts/stockfish.wasm.min.js' : './scripts/stockfish.min.js');
